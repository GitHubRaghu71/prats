    ...
    try:
        ...
        if len(exchsym) >= 2:
            ...
            if order_id:
                ...
                bot_token = '7374992903:AAEj_z7Cot0qDLJOQvQNKKUm-_zNoJgmAGk'  # Replace with your actual bot token
                user_usernames = ('7601958473')  # Replace with your Telegram username or ID
        ...
        if len(exchsym) >= 2 :
            ...
            if order_id:
                ...
                try:
                    ...
                    bot_token = '7374992903:AAEj_z7Cot0qDLJOQvQNKKUm-_zNoJgmAGk'  # Replace with your actual bot token
                    user_id = '7601958473'  # Replace with your Telegram user ID
                    async def send_telegram_message(message_text):
                        bot = telegram.Bot(token=bot_token)
...
###################################################################################"PXY® PreciseXceleratedYield Pvt Ltd™########################################################################################################################
    ...
    # Debugging - Remove
    print("combined_df before processing:")
    print(combined_df.head())   # Print first few rows
    print(combined_df.dtypes)   # Print column data types
